    ...
    <div className="space-y-6">
      ...
      <div className="rounded-xl p-6 shadow-sm" style={{ backgroundColor: 'var(--bg-secondary)', borderWidth: '1px', borderStyle: 'solid', borderColor: 'var(--border-color)' }}>
        <div className="flex flex-col lg:flex-row gap-4">
          ...
          {/* View Mode Toggle */}
          <div className="flex gap-1 px-2 py-1 rounded-lg" style={{ backgroundColor: 'var(--bg-primary)', borderWidth: '1px', borderStyle: 'solid', borderColor: 'var(--border-color)' }}>
            <button
              onClick={() => handleViewModeChange('list')}
              className={`p-2 rounded transition-colors duration-200 ${viewMode === 'list' ? 'bg-primary-500 text-white' : 'hover:bg-gray-200 dark:hover:bg-gray-700'}`}
              style={{ color: viewMode === 'list' ? undefined : 'var(--text-secondary)' }}
              title="List View"
            >
            ...
            <button
              ...
              className={`p-2 rounded transition-colors duration-200 ${viewMode === 'small-grid' ? 'bg-primary-500 text-white' : 'hover:bg-gray-200 dark:hover:bg-gray-700'}`}
              style={{ color: viewMode === 'small-grid' ? undefined : 'var(--text-secondary)' }}
              title="Small Grid"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button
              onClick={() => handleViewModeChange('medium-grid')}
              className={`p-2 rounded transition-colors duration-200 ${viewMode === 'medium-grid' ? 'bg-primary-500 text-white' : 'hover:bg-gray-200 dark:hover:bg-gray-700'}`}
              style={{ color: viewMode === 'medium-grid' ? undefined : 'var(--text-secondary)' }}
              title="Medium Grid"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button
              ...
              className={`p-2 rounded transition-colors duration-200 ${viewMode === 'large-grid' ? 'bg-primary-500 text-white' : 'hover:bg-gray-200 dark:hover:bg-gray-700'}`}
              style={{ color: viewMode === 'large-grid' ? undefined : 'var(--text-secondary)' }}
              title="Large Grid"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
